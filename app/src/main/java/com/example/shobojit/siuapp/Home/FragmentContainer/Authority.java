...
import com.example.shobojit.siuapp.Home.Activity.*;
...
public class Authority  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        auth3= (Button) v.findViewById(R.id.auth3);


        auth1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), com.example.shobojit.siuapp.Home.Activity.Chairman.class));
            }
        });
        ...
        auth3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), PRO.class));
            }
        });
